...
class MaterialLedgerScreen extends StatefulWidget {
  ...
  const MaterialLedgerScreen({super.key, required this.materialId, required this.materialName});
...
class _MaterialLedgerScreenState extends State<MaterialLedgerScreen> {
  ...
  Future<void> _load() async {
    final data = await DatabaseHelper.instance.getTransactionsByMaterial(widget.materialId);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('${widget.materialName} — Ledger')),
